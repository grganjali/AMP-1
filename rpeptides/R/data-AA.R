...
#' }
#' \item{crucianiProperties:} The three Cruciani et. al (2004) properties, are the scaled principal component scores that summarize a broad set of descriptors calculated based on the interaction of each amino acid residue with several chemical groups (or "probes"), such as d ions, methyl, hydroxyl groups, and so forth. \itemize{
#' \item{PP1:} Polarity,
